...
/*---------------------------------------------------------------------------
  ...
  There is usually no need to include this file since neounzip.h includes it.
  ...
  but this is defined after neounzip.h has been read.  If you are not careful,
  ...
  it also includes some object files from NeoUnZip.  If we were to conditionally
...
# endif
    ...
    zoff_t    extra_bytes;          /* used in neounzip.c, misc.c */
    uch       *extra_field;         /* Unix, VMS, Mac, OS/2, Acorn, ... */
    uch       *hold;

    local_file_hdr  lrec;          /* used in neounzip.c, extract.c */
    cdir_file_hdr   crec;          /* used in neounzip.c, extract.c, misc.c */
    ecdir_rec       ecrec;         /* used in neounzip.c, extract.c */
    ...
    char rgchSmallBuffer2[160];  /* boosted to 160 for local3[] in neounzip.c */
#endif
